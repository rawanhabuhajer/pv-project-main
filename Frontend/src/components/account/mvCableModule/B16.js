...
import { CFForConductorB16 } from "./MvData";
...
const B16 = ({
  ...
  const handleSpacingChange = (event, newValue) => {
    ...
    if (conductorSize && CFForConductorB16[conductorSize]) {
      setFactor(CFForConductorB16[conductorSize][newValue]);
    }
  };
  ...
  return (
    <>
      ...
      >
        {conductorSize &&
          Object.keys(CFForConductorB16[conductorSize]).map((space) => (
